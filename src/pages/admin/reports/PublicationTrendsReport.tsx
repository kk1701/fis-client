...
export default function PublicationTrendsReport() {
  ...
  const [chartType, setChartType] = useState<"category" | "indexing">(
    "category",
  );
      ...
      <div className="bg-white rounded-2xl shadow-sm p-6">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-xs text-gray-400 mt-0.5">
              Year-wise publication output analysis
            </p>
          </div>
        ...
        <div className="grid grid-cols-4 gap-4 mb-6">
          {[
            ...
            {
              label: "SCI Indexed",
              value: data.summary.SCI,
              color: "bg-blue-900 text-white",
            },
            {
              label: "Scopus Indexed",
              value: data.summary.SCOPUS,
              color: "bg-indigo-100 text-indigo-800",
            },
            {
              label: "Others",
              value: data.summary.NONE,
